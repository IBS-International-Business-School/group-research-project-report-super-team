...
Based on the results of A/B test, lifestyle images outperformed studio pictures in terms of engagement and information clarity, while studio images demonstrated more trust to participants. Therefore, the analysis suggests implementing a dual-image strategy that can enable consumers to have both view of trust and engagement. 
...
Each construct was measured using two statements, and we calculated the final scores for Engagement (E), Perceived Trust (PT), and Information Clarity (IC) by taking the average of those two items. This gave us a single score per construct, which kept things simple while still being reliable for comparing the two image styles.
...
For H2 (Trust + Information Clarity), the results didn’t give us statistical support. Information Clarity was slightly better under lifestyle images, but not by enough to count as significant. Trust actually leaned a bit higher for studio images, which suggests that the simple, clean background still gives people more confidence about what the product really looks like. Since both Trust and Information Clarity had p-values above 0.05, we cannot reject H₂, even though the lifestyle images did show a positive trend for clarity.

We also noticed something else that wasn’t directly tied to the image style: Lamps tended to be rated better than Glasses overall. In Version A (studio style), lamps scored higher for Engagement, Trust, and Information Clarity. In Version B (lifestyle style), lamps again scored higher for Trust and Information Clarity, but the Engagement difference wasn’t significant this time. This suggests there is some natural product bias happening, meaning people simply liked the lamp more regardless of which photo style it was shown in.

Finally, the demographic tests showed only small effects. Gender and “Most Exposed Country” had an influence on Information Clarity, but Age and Nationality didn’t make a significant difference. This tells us that while certain backgrounds can affect how easily someone interprets a product image, the general patterns of our results don’t change much across different groups.
...
Figure 1. Comparison of Studio (A) vs. Lifestyle (B) Image Styles Across Constructs
 <img width="940" height="598" alt="image" src="https://github.com/user-attachments/assets/9db67a6d-fd9a-4d16-9a55-1e27b6dda560" />
